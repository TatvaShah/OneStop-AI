  ...
  return (
    <div>
      <div id="generator">
        ...
        <p style={{ color: "rgb(158, 200, 185)" }} class="description">
        ...
        <div id="generator-feed" class="top-30">
          ...
          <ul id="generator-feed-type" class="tab-list"></ul>

          <div
            id="generator-feed-mansory"
            class="top-30 mansorary medium"
